...
{record.map((rec, recIndex) => {
    ...
    return (
        <div key={recIndex} className="flex flex-col w-[370px] my-5 border border-black">
                ...
                <tbody>
                    {rec.items.map((item, index) => (
                        <tr key={index}>
                            ...
                            <td className="px-3 py-1 text-center">{(rec.weights[index] * rec.rates[index]).toFixed(2)} Rs.</td>
                        </tr>
                    ))}
                </tbody>
            </table>
            <div className="flex justify-between">
                ...
                <span className="px-2">Total Price: Rs.{(totalPrice).toFixed(2)}</span>
            </div>
